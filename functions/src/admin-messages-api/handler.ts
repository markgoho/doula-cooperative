...
/**
 * Admin Messages API handler that bridges Firebase Functions with Elysia.
 ...
 */
export async function handleAdminMessagesApi(
  request: Request,
  response: Response,
  ...
  try {
    ...
    logger.error("Elysia admin-messages-api handler failed", errorDetails);
