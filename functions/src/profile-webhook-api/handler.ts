...
/**
 * Profile Webhook API handler that bridges Firebase Functions with Elysia.
 ...
 */
export async function handleProfileWebhookApi(
  request: Request,
  response: Response,
  ...
  try {
    ...
    logger.error("Elysia profile-webhook-api handler failed", errorDetails);
