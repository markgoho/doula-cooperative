...
/**
 * Admin Members API handler that bridges Firebase Functions with Elysia.
 ...
 */
export async function handleAdminMembersApi(
  request: Request,
  response: Response,
  ...
  try {
    ...
    const { toWebRequest, sendWebResponse } = await import("../shared-api/adapters.js");
    ...
    logger.error("Elysia admin-members-api handler failed", errorDetails);
